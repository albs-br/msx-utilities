...
namespace MsxUtilities.Test
{
    ...
    public class ConvertSc5ImageToSpritesTest
    {
        ...
        public void Test_DoConversion_2_Sprites_Offset_0_4()
        {
            ...
            // Assert
            byte[] assertPaletteFile = File.ReadAllBytes(@"AssertFiles\enemy_plane_1_without_offset_x.pal");
            byte[] assertPatternsFile = File.ReadAllBytes(@"AssertFiles\enemy_plane_1_without_offset_x.pat");
            byte[] assertColorsFile = File.ReadAllBytes(@"AssertFiles\enemy_plane_1_without_offset_x.col");
        ...
        [TestMethod]
        public void Test_DoConversion_2_Sprites_Offset_1_4()
        {
            // Arrange
            int sprite0_offsetX = 38, sprite0_offsetY = 36, sprite1_offsetX = 1, sprite1_offsetY = 4;
            int sprite0_width = 16, sprite0_height = 16;
            var paletteBytes = new byte[32];
            var patternBytes = new byte[64];
            var colorsBytes = new byte[32];
